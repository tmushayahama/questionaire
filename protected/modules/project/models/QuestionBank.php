...
class QuestionBank extends CActiveRecord {
  ...
  public static $SORT_BY_TIMES_ADDED = "times_added";
  public static $SORT_BY_TIMES_MODIFIED = "times_modified";
  public static $SORT_BY_YEAR = "year";
  public static $SORT_BY_TOOL = "tool";
  public static $SORT_BY_CONTENT = "content";
  public static $SORT_BY_AUTHOR = "author";
  public static $SORT_BY_CONCEPT = "concept";
  public static $ORDER_ASC = "asc";
  public static $ORDER_DESC = "desc";
  public $questionConceptList;
  public $questionYearList;

  public static function keywordSearch($keyword, $tool, $concept, $year, $sortId, $limit) {
    $keywordSearchCriteria = self::keywordSearchCriteria($keyword, $tool, $concept, $year);
    $keywordSearchCriteria->limit = $limit;
    if ($sortId != null) {
      $keywordSearchCriteria->order = $sortId;
    }
